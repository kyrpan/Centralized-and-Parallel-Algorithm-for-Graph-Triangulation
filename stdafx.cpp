...
* so it can be send over MPI to another processor
*/
...
/**
* returns the number of elements that exists on both vectors
* Figure 5 from the paper (main steps of NodeIteratorN)
*/
...
/**
* parses the file with adjacency lists
...
//returns rank of process that has the node as a core node
